// Make Skills object as Realm Object
...
class Skill: Object {
    ...
    @objc dynamic var authorUrl: String = ""
    @objc dynamic var examples: [String] = []
    @objc dynamic var author: String = ""
    @objc dynamic var skillName: String = ""
    @objc dynamic var skillDescription: String = ""
    @objc dynamic var dynamic_content: Bool = false
    @objc dynamic var skill_rating: [String: Any] = [:]
    @objc dynamic var stars: [String: Any] = [:]
    @objc dynamic var oneStar: Int = 0
    @objc dynamic var twoStar: Int = 0
    @objc dynamic var threeStar: Int = 0
    @objc dynamic  var fourStar: Int = 0
    @objc dynamic var fiveStar: Int = 0
    @objc dynamic var totalRatings: Int = 0
    @objc dynamic var averageRating: Double = 0.0
    @objc dynamic var skillKeyName: String = ""
    @objc dynamic var model: String = ""
    @objc dynamic var group: String = ""

    convenience init(dictionary: [String: AnyObject], skillKey: String ) {
        self.init()
